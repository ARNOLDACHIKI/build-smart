...
Complete step-by-step guide to deploy JengoPro to production on Vercel (frontend) and Render (backend).
...
3. Enter repository: `https://github.com/ARNOLDACHIKI/jengopro`
4. Click **Connect**
...
| `FRONTEND_URL` | Frontend domain (will deploy first to Vercel) | `https://jengopro.vercel.app` |
...
3. Deployment status visible at **Services** → **jengopro-backend**
4. Once live, note the service URL (e.g. `https://jengopro-backend-abc123.onrender.com`)
...
4. Enter: `https://github.com/ARNOLDACHIKI/jengopro`
5. Click **Continue**

### Step 2: Configure Vercel Project
1. **Project Name:** `jengopro` (or your choice)
...
4. Note the frontend URL (e.g. `https://jengopro.vercel.app`)

### Step 5: Update Backend FRONTEND_URL
1. Go back to **Render Dashboard** → **jengopro-backend**
...
- Check Render logs: **Services** → **jengopro-backend** → **Logs**
...
### Vercel
- **Deployments:** https://vercel.com/ARNOLDACHIKI/jengopro/deployments
- **Logs:** Click deployment → View Function Logs
- **Analytics:** Edge for free tier, real-time included

### Render
- **Deployments:** Dashboard → Services → jengopro-backend → Deploys
- **Live Logs:** Dashboard → Services → jengopro-backend → Logs
...
4. Check GitHub: https://github.com/ARNOLDACHIKI/jengopro/issues
