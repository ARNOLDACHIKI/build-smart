...
const translations: Translations = {
  ...
  'hero.step4': { en: 'Project management tools', sw: 'Zana za usimamizi wa miradi' },
  ...
  'features.aiPoweredSearchDesc': { en: 'Find the right professionals faster using smart filters, relevance scoring, and role matching', sw: 'Tafuta wataalamu sahihi haraka kwa vichujio mahiri, upangaji wa umuhimu na ulinganishaji wa majukumu' },
